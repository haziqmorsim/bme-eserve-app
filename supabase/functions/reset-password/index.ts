                                ...
                                <tr>
                                    <td align="center" bgcolor="${BRAND.blue}" style="border-radius:10px;">
                                        <a href="${actionLink}" target="_blank" rel="noopener"
                                           style="display:inline-block;padding:13px 30px;font-size:15px;font-weight:700;color:#ffffff;text-decoration:none;border-radius:10px;border-bottom:3px solid ${BRAND.green};">
                                            Reset Password
                                        </a>
                                    </td>
                                </tr>
